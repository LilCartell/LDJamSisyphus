...
public class Strings : MonoBehaviour
{
    ...
    public static Dictionary<string,string> GetFrenchDictionary()
    {
        return new Dictionary<string, string>()
        {
            ...
            {"TUTO_04", "Que j'ai au moins le temps d'aller pisser quand je la remonte !" },
            {"TUTO_05", "Je peux peut-être pimper un peu la colline..." },
            {"TUTO_06", "Dédale aura surement des trucs à me vendre pour ça !" },
